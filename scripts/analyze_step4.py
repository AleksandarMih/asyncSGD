...
Usage (from repo root):
  ...
  python scripts/analyze_step4.py --step3-dir outputs/step3 \\
...
def main() -> None:
    ...
    p.add_argument("--step3-dir", default="outputs/step3")
    p.add_argument("--step4-dir", default="outputs/step4")
    p.add_argument("--out-dir",   default="outputs/step4")
    args = p.parse_args()
