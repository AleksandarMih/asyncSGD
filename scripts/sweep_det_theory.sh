...
#
# Experiments (details in train.py docstring):
...
#   τ=20 ↔  β=0.95  ← new run
#
# The (τ=k, β=0) side already exists in det_grid; analyze_det_theory.py loads it there.
...
echo ""
echo "All $((total + e_total)) Exp A–E runs complete. Results in outputs/det_theory/"
