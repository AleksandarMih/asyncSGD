...
# Results are written to outputs/step4/ alongside Exp A–E data.
#
# After completion:
#   python scripts/analyze_step4.py   →  produces plot_K_negative_momentum.png
...
echo ""
echo "All ${total} Exp F runs complete. Results in outputs/step4/"
